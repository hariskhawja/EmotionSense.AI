...
const Navbar = () => {
    ...
    return (
        <div className={scrolled ? "button-container-active" : "button-container"}>
        <button class="button" onClick={() => handleClick('home')}>
        ...
        <button class="button" onClick={() => handleClick('results')}>
        ...
        <button class="button" onClick={() => handleClick('about')}>
